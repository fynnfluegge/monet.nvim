...
function M.get()
	...
	return {
		...
		BlinkCmpKindMethod = { fg = C.lightpeach },
		BlinkCmpKindFunction = { fg = C.lightpeach },
		BlinkCmpKindConstructor = { fg = C.lightpeach },
		BlinkCmpKindField = { fg = C.lightpeach },
		BlinkCmpKindClass = { fg = C.lightpeach },
		BlinkCmpKindInterface = { fg = C.lightpeach },
		BlinkCmpKindModule = { fg = C.lightpeach },
		BlinkCmpKindProperty = { fg = C.lightpeach },
		BlinkCmpKindUnit = { fg = C.lightpeach },
		BlinkCmpKindValue = { fg = C.lightpeach },
		BlinkCmpKindEnum = { fg = C.lightpeach },
		BlinkCmpKindKeyword = { fg = C.lightpeach },
		BlinkCmpKindSnippet = { fg = C.lightpeach },
		BlinkCmpKindColor = { fg = C.lightpeach },
		BlinkCmpKindFile = { fg = C.lightpeach },
		BlinkCmpKindReference = { fg = C.lightpeach },
		BlinkCmpKindFolder = { fg = C.lightpeach },
		BlinkCmpKindEnumMember = { fg = C.lightpeach },
		BlinkCmpKindConstant = { fg = C.lightpeach },
		BlinkCmpKindStruct = { fg = C.lightpeach },
		BlinkCmpKindEvent = { fg = C.lightpeach },
		BlinkCmpKindOperator = { fg = C.lightpeach },
